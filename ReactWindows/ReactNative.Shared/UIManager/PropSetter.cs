...
namespace ReactNative.UIManager
{
    abstract class PropSetter : IPropSetter
    {
        ...
        {
            throw new NotSupportedException($"'{nameof(ReactShadowNode)}' props cannot be changed with this setter.");
        }
        ...
        class ViewManagerPropSetter<TView> : PropSetter
        {
            ...
            protected override Type GetPropType(MethodInfo method)
            {
                ...
                {
                    throw new InvalidOperationException($"Wrong number of arguments for prop setter '{method.DeclaringType.Name}.{method.Name}'.");
                }
        ...
        class ViewManagerGroupPropSetter<TView> : PropSetter
        {
            ...
            protected override Type GetPropType(MethodInfo method)
            {
                ...
                {
                    throw new InvalidOperationException($"Wrong number of arguments for group prop setter '{method.DeclaringType.Name}.{method.Name}'.");
                }
